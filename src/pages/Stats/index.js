        ...
        setSubmissions(response.data.result.map((res) => (
          {
            ...
            target="_blank" rel="noopener noreferrer">{res.id}</a>,
            problem: <a href={`https://codeforces.com/contest/${res.contestId}/problem/${res.problem.index}`} 
            target="_blank" rel="noopener noreferrer">{res.problem.contestId}{res.problem.index}</a>,
